...
c = [32, 65, 131, 262, 523, 1046]
db= [34, 69, 139, 277, 554, 1108]
d = [36, 73, 147, 294, 587, 1174]
eb= [37, 78, 156, 311, 622, 1244]
e = [41, 82, 165, 330, 659, 1318]
f = [43, 87, 175, 349, 698, 1396]
gb= [46, 92, 185, 370, 740, 1480]
g = [49, 98, 196, 392, 784, 1568]
ab= [52, 104, 208, 415, 831, 1662]
a = [55, 110, 220, 440, 880, 1760]
bb= [58, 117, 223, 466, 932, 1864]
b = [61, 123, 246, 492, 984, 1968]
BB2 = [32, 43, 49, 58, 87, 98, 117, 131, 175, 349, 698, 740]
...
#playScale(aminor, 0.1)
#playScale(cmajor, 0.3)
playScale(mytest, 0.1)
...
starwars_notes = [c[4], g[4], f[4], e[4], d[4], c[4], g[4], f[4], e[4], d[4], c[4], g[4], 
              f[4], e[4], f[4], d[4]]
